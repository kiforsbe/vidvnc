        ...
        ? [
            {
              ...
              profile: session.profile?.label || session.profile?.name || 'Automatic',
              profileDescription: session.profile?.description ?? null,
              targetBitrateKbps: session.profile?.bitrateKbps ?? null,
