...
**Files:** Modify `README.md`, `docs/ARCHITECTURE.md`, `docs/security/internet-exposure-review-2026-09-24.md`, `docs/security/internet-exposure-hardening-status-2026-09-24.md`, and `CHANGELOG.md`; adjust older baseline/proposal links only if necessary. Preserve and incorporate their pre-existing uncommitted edits instead of replacing them.
